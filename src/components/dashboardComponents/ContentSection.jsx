...
function ContentSection({ email }) {
  ...
  return (
    <div className="h-[100%] w-[80%] rounded-xl bg-green-200 p-4 content_main_div">
      <style jsx>{`
      ...
      {isLoading ? (
        ...
        <>
          <section className="h-[50%] w-[100%]">
            <div className="text-slate-700 font-bold text-left p-2 h-[10%] rounded-lg starred_app_div">
              <h1 className="text-2xl">Starred Appointments</h1>
            </div>
            <div className="text-white mt-6 h-[90%] rounded-lg overflow-y-auto custom-scrollbar">
              <div>
                <div>
                  <table className="flex justify-center items-center bg-transparent w-full rounded-lg border-collapse custom-scrollbar">
                    <tbody className="flex flex-col w-full gap-1 overflow-x-auto custom-scrollbar">
                      <div
                        onClick={() => router.push(`/AllProfiles`)}
          ...
          <section className="h-[50%] w-full">
            ...
            <div className="text-white mt-5 h-[80%] rounded-lg overflow-y-auto custom-scrollbar">
              <div>
                <div>
                  <table className="flex justify-center items-center bg-transparent w-full rounded-lg border-collapse custom-scrollbar">
                    <tbody className="flex flex-col w-full gap-1 overflow-x-auto custom-scrollbar">
